          ...
          <div className={viewMode === 'grid'
            ...
            {filteredItems.map((item) => (
              <Link
                key={item._id}
                to={`/items/${item._id}`}
                className={`bg-white/80 backdrop-blur-md rounded-2xl shadow-md hover:shadow-xl transition-shadow ${
              ...
              >
                ...
                <div className={viewMode === 'list' ? 'flex-1' : 'p-4'}>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-medium text-pink-600">{item.pointValue} pts</span>
                  </div>
